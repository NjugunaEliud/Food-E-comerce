...
?>
<h3>Foods Available on offers</h3>
  ...
  <?php foreach ($foods as $food) { ?>
    <div class="product-card">
        ...
        <div class="product-details">
            ...
            <p class="discount-price" style="text-align: center; font:bold; paddind-top:20px;">£<?php echo $food['price']; ?></p>
        </div>
        <h3 style="color: brown;">Buy Two Plates get One Free</h3>
        <h3>Offer valid for 3 weeks</h3>
    </div>
